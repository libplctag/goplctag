...
// CreateEx function as declared in include/libplctag.h:209
// func CreateEx(attribStr string, tagCallbackFunc *func(tagId int32, event int32, status int32, userdata unsafe.Pointer), userdata unsafe.Pointer, timeout int32) int32 {
// 	cattribStr, cattribStrAllocMap := unpackPCharString(attribStr)
// 	ctagCallbackFunc, ctagCallbackFuncAllocMap := tagCallbackFunc.PassRef()
// 	cuserdata, cuserdataAllocMap := userdata, cgoAllocsUnknown
// 	ctimeout, ctimeoutAllocMap := (C.int)(timeout), cgoAllocsUnknown
// 	__ret := C.plc_tag_create_ex(cattribStr, ctagCallbackFunc, cuserdata, ctimeout)
// 	runtime.KeepAlive(ctimeoutAllocMap)
// 	runtime.KeepAlive(cuserdataAllocMap)
// 	runtime.KeepAlive(ctagCallbackFuncAllocMap)
// 	runtime.KeepAlive(cattribStrAllocMap)
// 	__v := (int32)(__ret)
// 	return __v
// }
...
// RegisterCallback function as declared in include/libplctag.h:283
// func RegisterCallback(tagId int32, tagCallbackFunc *func(tagId int32, event int32, status int32)) int32 {
// 	ctagId, ctagIdAllocMap := (C.int32_t)(tagId), cgoAllocsUnknown
// 	ctagCallbackFunc, ctagCallbackFuncAllocMap := tagCallbackFunc.PassRef()
// 	__ret := C.plc_tag_register_callback(ctagId, ctagCallbackFunc)
// 	runtime.KeepAlive(ctagCallbackFuncAllocMap)
...
// RegisterCallbackEx function as declared in include/libplctag.h:285
// func RegisterCallbackEx(tagId int32, tagCallbackFunc *func(tagId int32, event int32, status int32, userdata unsafe.Pointer), userdata unsafe.Pointer) int32 {
// 	ctagId, ctagIdAllocMap := (C.int32_t)(tagId), cgoAllocsUnknown
// 	ctagCallbackFunc, ctagCallbackFuncAllocMap := tagCallbackFunc.PassRef()
// 	cuserdata, cuserdataAllocMap := userdata, cgoAllocsUnknown
// 	__ret := C.plc_tag_register_callback_ex(ctagId, ctagCallbackFunc, cuserdata)
// 	runtime.KeepAlive(cuserdataAllocMap)
// 	runtime.KeepAlive(ctagCallbackFuncAllocMap)
// 	runtime.KeepAlive(ctagIdAllocMap)
// 	__v := (int32)(__ret)
...
// RegisterLogger function as declared in include/libplctag.h:324
// func RegisterLogger(logCallbackFunc *func(tagId int32, debugLevel int32, message string)) int32 {
// 	clogCallbackFunc, clogCallbackFuncAllocMap := logCallbackFunc.PassRef()
// 	__ret := C.plc_tag_register_logger(clogCallbackFunc)
// 	runtime.KeepAlive(clogCallbackFuncAllocMap)
// 	__v := (int32)(__ret)
// 	return __v
// }
